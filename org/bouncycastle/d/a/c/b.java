package org.bouncycastle.d.a.c;

/* JADX INFO: loaded from: classes.dex */
public abstract class b {
    private static final int[] a = {34513072, 59165138, 4688974, 3500415, 6194736, 33281959, 54535759, 32551604, 163342, 5703241};
    ...
    private static void a(byte[] bArr, int i, int[] iArr, int i2) {
        int iA = a(bArr, i + 0);
        int iA2 = a(bArr, i + 4);
        int iA3 = a(bArr, i + 8);
        int iA4 = a(bArr, i + 12);
        iArr[i2 + 0] = iA & 67108863;
        iArr[i2 + 1] = ((iA >>> 26) | (iA2 << 6)) & 67108863;
        iArr[i2 + 2] = ((iA2 >>> 20) | (iA3 << 12)) & 33554431;
        iArr[i2 + 3] = ((iA4 << 19) | (iA3 >>> 13)) & 67108863;
        iArr[i2 + 4] = iA4 >>> 7;
    }
    ...
    private static void a(int[] iArr, int i, byte[] bArr, int i2) {
        int i3 = iArr[i + 0];
        int i4 = iArr[i + 1];
        int i5 = iArr[i + 2];
        int i6 = iArr[i + 3];
        int i7 = iArr[i + 4];
        a(i3 | (i4 << 26), bArr, i2 + 0);
        a((i4 >>> 6) | (i5 << 20), bArr, i2 + 4);
        a((i5 >>> 12) | (i6 << 13), bArr, i2 + 8);
        a((i6 >>> 19) | (i7 << 7), bArr, i2 + 12);
    }
    ...
    private static void e(int[] iArr, int[] iArr2, int[] iArr3) {
        d(iArr, iArr2);
        b(iArr, iArr2, iArr2);
        int[] iArr4 = new int[10];
        d(iArr2, iArr4);
