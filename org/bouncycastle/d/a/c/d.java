...
public abstract class d {
    ...
    private static void a(byte[] bArr, int i, int[] iArr, int i2) {
        int iB = b(bArr, i);
        int iA = a(bArr, i + 4);
        iArr[i2] = 268435455 & iB;
        iArr[i2 + 1] = (iB >>> 28) | (iA << 4);
    }
    ...
    private static void b(int[] iArr, int i, int[] iArr2) {
        c(iArr, iArr2);
        while (true) {
            i--;
            if (i <= 0) {
    ...
    public static void b(int[] iArr, int[] iArr2) {
        d(new int[16], iArr, iArr2);
    }

    private static void d(int[] iArr, int[] iArr2) {
        int[] iArr3 = new int[16];
        c(iArr, iArr3);
        b(iArr, iArr3, iArr3);
        ...
        b(iArr9, 37, iArr10);
        b(iArr9, iArr10, iArr10);
        int[] iArr11 = new int[16];
        b(iArr10, 37, iArr11);
        b(iArr9, iArr11, iArr11);
        int[] iArr12 = new int[16];
        b(iArr11, 111, iArr12);
        b(iArr11, iArr12, iArr12);
        int[] iArr13 = new int[16];
        c(iArr12, iArr13);
        b(iArr, iArr13, iArr13);
        int[] iArr14 = new int[16];
        b(iArr13, 223, iArr14);
        b(iArr14, iArr12, iArr2);
    }
