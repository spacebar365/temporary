...
public final class ca extends j$a {
    public ca(org.bouncycastle.d.a.d dVar, org.bouncycastle.d.a.g gVar, org.bouncycastle.d.a.g gVar2) {
        this(dVar, gVar, gVar2, false);
    }

    public ca(org.bouncycastle.d.a.d dVar, org.bouncycastle.d.a.g gVar, org.bouncycastle.d.a.g gVar2, boolean z) {
    ...
    ca(org.bouncycastle.d.a.d dVar, org.bouncycastle.d.a.g gVar, org.bouncycastle.d.a.g gVar2, org.bouncycastle.d.a.g[] gVarArr, boolean z) {
    ...
    public final org.bouncycastle.d.a.j b(org.bouncycastle.d.a.j jVar) {
        ...
        if (gVarK.j()) {
            ...
            gVarC4 = gVarD.e().a(gVarD).a(gVarI).c();
            if (gVarC4.j()) {
                return new ca(dVarD, gVarC4, dVarD.h(), this.f);
            }
        ...
        return new ca(dVarD, gVarC4, gVarA, new org.bouncycastle.d.a.g[]{gVarC5}, this.f);
    }
    ...
    public final org.bouncycastle.d.a.j d(org.bouncycastle.d.a.j jVar) {
        ...
        org.bouncycastle.d.a.g gVarA2 = gVarE3.a(gVarE2).a(gVar2.c(gVar3));
        org.bouncycastle.d.a.g gVarB = gVarL.c(gVarE3).a(gVarE2).b(gVarA2, gVarE, gVarE3);
        org.bouncycastle.d.a.g gVarC = gVarK.c(gVarE3);
        org.bouncycastle.d.a.g gVarE4 = gVarC.a(gVarA2).e();
        if (gVarE4.j()) {
            return gVarB.j() ? jVar.t() : dVarD.e();
        }
        if (gVarB.j()) {
            return new ca(dVarD, gVarB, dVarD.h(), this.f);
        }
        org.bouncycastle.d.a.g gVarC2 = gVarB.e().c(gVarC);
        org.bouncycastle.d.a.g gVarC3 = gVarB.c(gVarE4).c(gVarE3);
        return new ca(dVarD, gVarC2, gVarB.a(gVarE4).e().b(gVarA2, gVarL.c(), gVarC3), new org.bouncycastle.d.a.g[]{gVarC3}, this.f);
    }

    @Override // org.bouncycastle.d.a.j
    protected final org.bouncycastle.d.a.j e() {
        return new ca(null, g(), h());
    }
    ...
    public final org.bouncycastle.d.a.j s() {
        ...
        org.bouncycastle.d.a.g gVar2 = this.d;
        org.bouncycastle.d.a.g gVar3 = this.e[0];
        return new ca(this.b, gVar, gVar2.a(gVar3), new org.bouncycastle.d.a.g[]{gVar3}, this.f);
    }
    ...
    public final org.bouncycastle.d.a.j t() {
        ...
        org.bouncycastle.d.a.g gVar2 = this.d;
        org.bouncycastle.d.a.g gVarE = this.e[0];
        boolean zI = gVarE.i();
        org.bouncycastle.d.a.g gVarC = zI ? gVar2 : gVar2.c(gVarE);
        if (!zI) {
            gVarE = gVarE.e();
        }
        org.bouncycastle.d.a.g gVarA = gVar2.e().a(gVarC).a(gVarE);
        if (gVarA.j()) {
            return new ca(dVarD, gVarA, dVarD.h(), this.f);
        }
        ...
        return new ca(dVarD, gVarE2, gVarE3.a(gVarA).a(gVarE).c(gVarE3).a(gVarE2), new org.bouncycastle.d.a.g[]{gVarC2}, this.f);
    }
}
