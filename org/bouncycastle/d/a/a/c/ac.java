...
public final class ac extends d$b {
    public static final BigInteger i = new BigInteger(1, org.bouncycastle.f.a.f.a("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D"));
    protected ag j;

    public ac() {
        super(i);
        this.j = new ag(this, null, null);
        this.b = a(org.bouncycastle.d.a.c.c);
        this.c = a(BigInteger.valueOf(5L));
        this.d = new BigInteger(1, org.bouncycastle.f.a.f.a("010000000000000000000000000001DCE8D2EC6184CAF0A971769FB1F7"));
    ...
    public final org.bouncycastle.d.a.h a(org.bouncycastle.d.a.j[] jVarArr, int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            org.bouncycastle.d.c.g.a(((af) jVar.k()).b, iArr, i3);
            int i5 = i3 + 7;
            org.bouncycastle.d.c.g.a(((af) jVar.l()).b, iArr, i5);
            i3 = i5 + 7;
        }
        return new ad(this, i2, iArr);
    }

    @Override // org.bouncycastle.d.a.d
    protected final org.bouncycastle.d.a.j a(org.bouncycastle.d.a.g gVar, org.bouncycastle.d.a.g gVar2, boolean z) {
        return new ag(this, gVar, gVar2, z);
    }
    ...
    protected final org.bouncycastle.d.a.j a(org.bouncycastle.d.a.g gVar, org.bouncycastle.d.a.g gVar2, org.bouncycastle.d.a.g[] gVarArr, boolean z) {
        return new ag(this, gVar, gVar2, gVarArr, z);
    }
