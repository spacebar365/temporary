...
public final class ct extends j$a {
    public ct(org.bouncycastle.d.a.d dVar, org.bouncycastle.d.a.g gVar, org.bouncycastle.d.a.g gVar2) {
        this(dVar, gVar, gVar2, false);
    }

    public ct(org.bouncycastle.d.a.d dVar, org.bouncycastle.d.a.g gVar, org.bouncycastle.d.a.g gVar2, boolean z) {
    ...
    ct(org.bouncycastle.d.a.d dVar, org.bouncycastle.d.a.g gVar, org.bouncycastle.d.a.g gVar2, org.bouncycastle.d.a.g[] gVarArr, boolean z) {
    ...
    public final org.bouncycastle.d.a.j b(org.bouncycastle.d.a.j jVar) {
        ...
        if (gVarK.j()) {
            ...
            if (gVarC4.j()) {
                return new ct(dVarD, gVarC4, dVarD.h(), this.f);
            }
        ...
        return new ct(dVarD, gVarC4, gVarA, new org.bouncycastle.d.a.g[]{gVarC5}, this.f);
    }
    ...
    public final org.bouncycastle.d.a.j d(org.bouncycastle.d.a.j jVar) {
        ...
        if (gVarB.j()) {
            return new ct(dVarD, gVarB, dVarD.h(), this.f);
        }
        org.bouncycastle.d.a.g gVarC3 = gVarB.e().c(gVarC2);
        org.bouncycastle.d.a.g gVarC4 = gVarB.c(gVarE4).c(gVarE3);
        return new ct(dVarD, gVarC3, gVarB.a(gVarE4).e().b(gVarA2, gVarC, gVarC4), new org.bouncycastle.d.a.g[]{gVarC4}, this.f);
    }

    @Override // org.bouncycastle.d.a.j
    protected final org.bouncycastle.d.a.j e() {
        return new ct(null, g(), h());
    }
    ...
    public final org.bouncycastle.d.a.j s() {
        ...
        org.bouncycastle.d.a.g gVar2 = this.d;
        org.bouncycastle.d.a.g gVar3 = this.e[0];
        return new ct(this.b, gVar, gVar2.a(gVar3), new org.bouncycastle.d.a.g[]{gVar3}, this.f);
    }
    ...
    public final org.bouncycastle.d.a.j t() {
        ...
        if (gVarA.j()) {
            return new ct(dVarD, gVarA, dVarD.h(), this.f);
        }
        ...
        return new ct(dVarD, gVarE2, gVarE3.a(gVarA).a(gVarE).c(gVarE3).a(zI ? gVar3 : gVarE.e()).a(gVarE2).a(gVarC), new org.bouncycastle.d.a.g[]{gVarC}, this.f);
    }
}
