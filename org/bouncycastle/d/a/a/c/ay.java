...
public final class ay {
    ...
    public static void a(int i, int[] iArr) {
        ...
        if ((j == 0 || org.bouncycastle.d.c.c.b(12, iArr, 5) == 0) && !(iArr[11] == -1 && org.bouncycastle.d.c.c.c(12, iArr, a))) {
            return;
        }
        a(iArr);
    }
    ...
    private static void a(int[] iArr) {
        ...
        iArr[4] = (int) j6;
        if ((j6 >> 32) != 0) {
            org.bouncycastle.d.c.c.b(12, iArr, 5);
        }
    }

    public static void a(int[] iArr, int[] iArr2) {
        if (org.bouncycastle.d.c.c.d(12, iArr, iArr2) != 0 || (iArr2[11] == -1 && org.bouncycastle.d.c.c.c(12, iArr2, a))) {
            a(iArr2);
        }
    }

    public static void a(int[] iArr, int[] iArr2, int[] iArr3) {
        if (org.bouncycastle.d.c.c.a(12, iArr, iArr2, iArr3) != 0 || (iArr3[11] == -1 && org.bouncycastle.d.c.c.c(12, iArr3, a))) {
            a(iArr3);
        }
    }

    public static int[] a(BigInteger bigInteger) {
        int[] iArrA = org.bouncycastle.d.c.c.a(384, bigInteger);
        if (iArrA[11] == -1 && org.bouncycastle.d.c.c.c(12, iArrA, a)) {
            org.bouncycastle.d.c.c.e(12, a, iArrA);
        }
        return iArrA;
    }

    public static void b(int[] iArr, int[] iArr2) {
        if (org.bouncycastle.d.c.c.c(12, iArr)) {
            org.bouncycastle.d.c.c.e(12, iArr2);
        } else {
            org.bouncycastle.d.c.c.c(12, a, iArr, iArr2);
        }
    }

    public static void b(int[] iArr, int[] iArr2, int[] iArr3) {
        if ((org.bouncycastle.d.c.c.a(24, iArr, iArr2, iArr3) != 0 || (iArr3[23] == -1 && org.bouncycastle.d.c.c.c(24, iArr3, b))) && org.bouncycastle.d.c.c.a(c.length, c, iArr3) != 0) {
            org.bouncycastle.d.c.c.b(24, iArr3, c.length);
        }
    }
    ...
    public static void c(int[] iArr, int[] iArr2) {
        ...
        iArr2[11] = (int) j28;
        a((int) ((j28 >> 32) + 1), iArr2);
    }

    public static void e(int[] iArr, int[] iArr2) {
        if (org.bouncycastle.d.c.c.a(12, iArr, 0, iArr2) != 0 || (iArr2[11] == -1 && org.bouncycastle.d.c.c.c(12, iArr2, a))) {
            a(iArr2);
        }
    }
    ...
    public static void c(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        org.bouncycastle.d.c.j.a(iArr, iArr2, iArr4);
        c(iArr4, iArr3);
    }

    public static void d(int[] iArr, int[] iArr2) {
        int[] iArr3 = new int[24];
        org.bouncycastle.d.c.j.a(iArr, iArr3);
        c(iArr3, iArr2);
    }
    ...
    public static void a(int[] iArr, int i, int[] iArr2) {
        ...
        while (true) {
            ...
            org.bouncycastle.d.c.j.a(iArr2, iArr3);
            c(iArr3, iArr2);
        }
    }

    public static void d(int[] iArr, int[] iArr2, int[] iArr3) {
        if (org.bouncycastle.d.c.c.c(12, iArr, iArr2, iArr3) != 0) {
            ...
            iArr3[4] = (int) j6;
            if ((j6 >> 32) != 0) {
                org.bouncycastle.d.c.c.a(12, iArr3, 5);
            }
        }
    }
}
