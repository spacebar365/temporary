...
public final class bn extends j$a {
    public bn(org.bouncycastle.d.a.d dVar, org.bouncycastle.d.a.g gVar, org.bouncycastle.d.a.g gVar2) {
        this(dVar, gVar, gVar2, false);
    }

    public bn(org.bouncycastle.d.a.d dVar, org.bouncycastle.d.a.g gVar, org.bouncycastle.d.a.g gVar2, boolean z) {
    ...
    bn(org.bouncycastle.d.a.d dVar, org.bouncycastle.d.a.g gVar, org.bouncycastle.d.a.g gVar2, org.bouncycastle.d.a.g[] gVarArr, boolean z) {
    ...
    public final org.bouncycastle.d.a.j b(org.bouncycastle.d.a.j jVar) {
        ...
        if (gVarK.j()) {
            ...
            if (gVarC4.j()) {
                return new bn(dVarD, gVarC4, dVarD.h().g(), this.f);
            }
        ...
        return new bn(dVarD, gVarC4, gVarA, new org.bouncycastle.d.a.g[]{gVarC5}, this.f);
    }
    ...
    public final org.bouncycastle.d.a.j d(org.bouncycastle.d.a.j jVar) {
        ...
        if (gVarB.j()) {
            return new bn(dVarD, gVarB, dVarD.h().g(), this.f);
        }
        org.bouncycastle.d.a.g gVarC3 = gVarB.e().c(gVarC2);
        org.bouncycastle.d.a.g gVarC4 = gVarB.c(gVarE4).c(gVarE3);
        return new bn(dVarD, gVarC3, gVarB.a(gVarE4).e().b(gVarA2, gVarC, gVarC4), new org.bouncycastle.d.a.g[]{gVarC4}, this.f);
    }

    @Override // org.bouncycastle.d.a.j
    protected final org.bouncycastle.d.a.j e() {
        return new bn(null, g(), h());
    }
    ...
    public final org.bouncycastle.d.a.j s() {
        ...
        org.bouncycastle.d.a.g gVar2 = this.d;
        org.bouncycastle.d.a.g gVar3 = this.e[0];
        return new bn(this.b, gVar, gVar2.a(gVar3), new org.bouncycastle.d.a.g[]{gVar3}, this.f);
    }
    ...
    public final org.bouncycastle.d.a.j t() {
        ...
        if (gVarA.j()) {
            return new bn(dVarD, gVarA, dVarD.h().g(), this.f);
        }
        org.bouncycastle.d.a.g gVarE2 = gVarA.e();
        org.bouncycastle.d.a.g gVarC2 = zI ? gVarA : gVarA.c(gVarE);
        return new bn(dVarD, gVarE2, (zI ? gVar : gVar.c(gVar3)).a(gVarA, gVarC).a(gVarE2).a(gVarC2), new org.bouncycastle.d.a.g[]{gVarC2}, this.f);
    }
}
