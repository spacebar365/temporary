...
public final class r implements org.bouncycastle.b.e {
    ...
    private static long a(long j2) {
        long jC = c(j2);
        long jA = a(8, j2) ^ j2;
        long jA2 = (jA ^ a(16, jA)) ^ a(48, j2);
        return a(48, jC) ^ ((jA2 ^ a(32, d((jA2 ^ j2) ^ jC))) ^ a(40, jC));
    }
    ...
    private void a(long[] jArr, long[] jArr2) {
        ...
        this.a = new long[this.d];
        long[] jArr5 = this.a;
        jArr5[0] = jArr5[0] + ((long) (this.d + this.e + 1));
        if (this.d == this.e) {
            System.arraycopy(jArr, 0, jArr3, 0, jArr3.length);
            System.arraycopy(jArr, 0, jArr4, 0, jArr4.length);
        } else {
            System.arraycopy(jArr, 0, jArr3, 0, this.d);
            System.arraycopy(jArr, this.d, jArr4, 0, this.d);
        }
        for (int i2 = 0; i2 < this.a.length; i2++) {
            long[] jArr6 = this.a;
            jArr6[i2] = jArr6[i2] + jArr3[i2];
        }
        e();
        g();
        h();
    ...
    private static long b(long j2) {
        long jA = a(8, j2) ^ j2;
        long jA2 = (jA ^ a(32, jA)) ^ a(48, j2);
        long j3 = jA2 ^ j2;
        long jA3 = a(48, j2);
        long jA4 = a(56, j2);
        long jC = c(j3 ^ jA4) ^ a(56, j3);
        long jC2 = c(a(40, c(jC) ^ j2) ^ (a(16, j3) ^ j2)) ^ (j3 ^ jA3);
        return jA2 ^ c(a(40, ((a(32, j3) ^ j2) ^ jA4) ^ c(((jA3 ^ (a(24, j2) ^ j3)) ^ jA4) ^ c(c(jC2) ^ a(16, jA2)))));
    }
    ...
    private void b(byte[] bArr, int i2, byte[] bArr2, int i3) {
        long jD = org.bouncycastle.f.g.d(bArr, i2);
        long jD2 = org.bouncycastle.f.g.d(bArr, i2 + 8);
        long[] jArr = this.c[this.f];
        long j2 = jD - jArr[0];
        long j3 = jD2 - jArr[1];
        int i4 = this.f;
        while (true) {
            ...
            int i7 = (int) jB2;
            int i8 = (int) (jB2 >>> 32);
            int i9 = (l[i5 & 255] & 255) | ((m[(i5 >>> 8) & 255] & 255) << 8) | ((n[(i5 >>> 16) & 255] & 255) << 16) | (o[i5 >>> 24] << 24);
            long j4 = (((long) ((o[i8 >>> 24] << 24) | (((l[i8 & 255] & 255) | ((m[(i8 >>> 8) & 255] & 255) << 8)) | ((n[(i8 >>> 16) & 255] & 255) << 16)))) << 32) | (((long) i9) & 4294967295L);
            long j5 = (((long) ((o[i7 >>> 24] << 24) | (l[i7 & 255] & 255) | ((m[(i7 >>> 8) & 255] & 255) << 8) | ((n[(i7 >>> 16) & 255] & 255) << 16))) & 4294967295L) | (((long) ((o[i6 >>> 24] << 24) | (((l[i6 & 255] & 255) | ((m[(i6 >>> 8) & 255] & 255) << 8)) | ((n[(i6 >>> 16) & 255] & 255) << 16)))) << 32);
            i4--;
            if (i4 == 0) {
                long[] jArr2 = this.c[0];
                long j6 = j4 - jArr2[0];
                long j7 = j5 - jArr2[1];
                org.bouncycastle.f.g.b(j6, bArr2, i3);
                org.bouncycastle.f.g.b(j7, bArr2, i3 + 8);
                return;
            }
    ...
    private void b(long[] jArr, long[] jArr2) {
        long[] jArr3 = new long[this.e];
        long[] jArr4 = new long[this.d];
        System.arraycopy(jArr, 0, jArr3, 0, this.e);
        long j2 = 281479271743489L;
        int i2 = 0;
        while (true) {
            for (int i3 = 0; i3 < this.d; i3++) {
                jArr4[i3] = jArr2[i3] + j2;
            }
            for (int i4 = 0; i4 < this.d; i4++) {
                this.a[i4] = jArr3[i4] + jArr4[i4];
            }
            e();
            g();
            h();
            ...
            System.arraycopy(this.a, 0, this.c[i2], 0, this.d);
            if (this.f == i2) {
                return;
            }
            if (this.d != this.e) {
                ...
                for (int i7 = 0; i7 < this.d; i7++) {
                    jArr4[i7] = jArr2[i7] + j3;
                }
                for (int i8 = 0; i8 < this.d; i8++) {
                    this.a[i8] = jArr3[this.d + i8] + jArr4[i8];
                }
                e();
                g();
                h();
            ...
            long j4 = j2 << 1;
            long j5 = jArr3[0];
            for (int i11 = 1; i11 < jArr3.length; i11++) {
                jArr3[i11 - 1] = jArr3[i11];
            }
            jArr3[jArr3.length - 1] = j5;
            j2 = j4;
        }
    }

    private static long c(long j2) {
        return ((9187201950435737471L & j2) << 1) ^ ((((-9187201950435737472L) & j2) >>> 7) * 29);
    }
    ...
    private void c(byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        while (true) {
            ...
            int i7 = (int) j3;
            int i8 = (int) (j3 >>> 32);
            int i9 = (h[i5 & 255] & 255) | ((i[(i5 >>> 8) & 255] & 255) << 8) | ((j[(i5 >>> 16) & 255] & 255) << 16) | (k[i5 >>> 24] << 24);
            byte b = h[i8 & 255];
            byte b2 = i[(i8 >>> 8) & 255];
            byte b3 = j[(i8 >>> 16) & 255];
            long j4 = (((long) ((k[i8 >>> 24] << 24) | (((b & 255) | ((b2 & 255) << 8)) | ((b3 & 255) << 16)))) << 32) | (((long) i9) & 4294967295L);
            byte b4 = h[i7 & 255];
            byte b5 = i[(i7 >>> 8) & 255];
            byte b6 = j[(i7 >>> 16) & 255];
            int i10 = (k[i7 >>> 24] << 24) | (b4 & 255) | ((b5 & 255) << 8) | ((b6 & 255) << 16);
            byte b7 = h[i6 & 255];
            byte b8 = i[(i6 >>> 8) & 255];
            byte b9 = j[(i6 >>> 16) & 255];
            long j5 = ((long) ((k[i6 >>> 24] << 24) | (((b7 & 255) | ((b8 & 255) << 8)) | ((b9 & 255) << 16)))) << 32;
            long jA = a(j4);
            long jA2 = a(j5 | (((long) i10) & 4294967295L));
            i4++;
            if (i4 == this.f) {
                long[] jArr2 = this.c[this.f];
                long j6 = jA + jArr2[0];
                long j7 = jArr2[1] + jA2;
                org.bouncycastle.f.g.b(j6, bArr2, i3);
                org.bouncycastle.f.g.b(j7, bArr2, i3 + 8);
    ...
    private static long d(long j2) {
        return (((4557430888798830399L & j2) << 2) ^ ((((-9187201950435737472L) & j2) >>> 6) * 29)) ^ (((4629771061636907072L & j2) >>> 6) * 29);
    }
    ...
    private void e() {
        for (int i2 = 0; i2 < this.d; i2++) {
            ...
            byte b2 = i[(i3 >>> 8) & 255];
            byte b3 = j[(i3 >>> 16) & 255];
            int i5 = (k[i3 >>> 24] << 24) | (b & 255) | ((b2 & 255) << 8) | ((b3 & 255) << 16);
            byte b4 = h[i4 & 255];
            byte b5 = i[(i4 >>> 8) & 255];
            byte b6 = j[(i4 >>> 16) & 255];
            this.a[i2] = (((long) i5) & 4294967295L) | (((long) ((k[i4 >>> 24] << 24) | (((b4 & 255) | ((b5 & 255) << 8)) | ((b6 & 255) << 16)))) << 32);
        }
    }
    ...
    private void f() {
        for (int i2 = 0; i2 < this.d; i2++) {
            ...
            byte b2 = m[(i3 >>> 8) & 255];
            byte b3 = n[(i3 >>> 16) & 255];
            int i5 = (o[i3 >>> 24] << 24) | (b & 255) | ((b2 & 255) << 8) | ((b3 & 255) << 16);
            byte b4 = l[i4 & 255];
            byte b5 = m[(i4 >>> 8) & 255];
            byte b6 = n[(i4 >>> 16) & 255];
            this.a[i2] = (((long) i5) & 4294967295L) | (((long) ((o[i4 >>> 24] << 24) | (((b4 & 255) | ((b5 & 255) << 8)) | ((b6 & 255) << 16)))) << 32);
        }
    }
    ...
    private void g() {
        switch (this.d) {
            ...
            case 8:
                ...
                long j25 = this.a[6];
                long j26 = this.a[7];
                long j27 = (j19 ^ j23) & (-4294967296L);
                long j28 = j19 ^ j27;
                long j29 = j23 ^ j27;
                long j30 = (j20 ^ j24) & 72057594021150720L;
                long j31 = j20 ^ j30;
                long j32 = j24 ^ j30;
                long j33 = (j21 ^ j25) & 281474976645120L;
                long j34 = j21 ^ j33;
                long j35 = j25 ^ j33;
                long j36 = (j22 ^ j26) & 1099511627520L;
                long j37 = j22 ^ j36;
                long j38 = j26 ^ j36;
                long j39 = (j28 ^ j34) & (-281470681808896L);
                long j40 = j28 ^ j39;
                long j41 = j34 ^ j39;
                long j42 = (j31 ^ j37) & 72056494543077120L;
                long j43 = j31 ^ j42;
                long j44 = j37 ^ j42;
                long j45 = (j29 ^ j35) & (-281470681808896L);
                long j46 = j29 ^ j45;
                long j47 = j35 ^ j45;
                long j48 = (j32 ^ j38) & 72056494543077120L;
                long j49 = j32 ^ j48;
                long j50 = j38 ^ j48;
                long j51 = (j40 ^ j43) & (-71777214294589696L);
                long j52 = j40 ^ j51;
                long j53 = j43 ^ j51;
                long j54 = (j41 ^ j44) & (-71777214294589696L);
                long j55 = j41 ^ j54;
                long j56 = j44 ^ j54;
    ...
    public final int a(byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        if ((this.d << 3) + i2 > bArr.length) {
            throw new org.bouncycastle.b.o("Input buffer too short");
        }
        if ((this.d << 3) + i3 > bArr2.length) {
        ...
        if (this.g) {
            switch (this.d) {
                case 2:
                    ...
                    break;
                default:
                    org.bouncycastle.f.g.b(bArr, i2, this.a);
                    a(0);
                    int i4 = 0;
                    while (true) {
                        e();
                        ...
                        if (i4 == this.f) {
                            a(this.f);
                            org.bouncycastle.f.g.b(this.a, bArr2, i3);
                        } else {
                            c(i4);
                        }
                        break;
                    ...
                    while (true) {
                        ...
                        switch (this.d) {
                            ...
                            case 8:
                                ...
                                long j25 = this.a[6];
                                long j26 = this.a[7];
                                long j27 = (j19 ^ j20) & (-71777214294589696L);
                                long j28 = j19 ^ j27;
                                long j29 = j20 ^ j27;
                                long j30 = (j21 ^ j22) & (-71777214294589696L);
                                long j31 = j21 ^ j30;
                                long j32 = j22 ^ j30;
                                long j33 = (j23 ^ j24) & (-71777214294589696L);
                                long j34 = j23 ^ j33;
                                long j35 = j24 ^ j33;
                                long j36 = (j25 ^ j26) & (-71777214294589696L);
                                long j37 = j25 ^ j36;
                                long j38 = j26 ^ j36;
                                long j39 = (j28 ^ j31) & (-281470681808896L);
                                long j40 = j28 ^ j39;
                                long j41 = j31 ^ j39;
                                long j42 = (j29 ^ j32) & 72056494543077120L;
                                long j43 = j29 ^ j42;
                                long j44 = j32 ^ j42;
                                ...
                                long j49 = j35 ^ j48;
                                long j50 = j38 ^ j48;
                                long j51 = (j40 ^ j46) & (-4294967296L);
                                long j52 = j40 ^ j51;
                                long j53 = j46 ^ j51;
                                long j54 = (j43 ^ j49) & 72057594021150720L;
                                long j55 = j43 ^ j54;
                                long j56 = j49 ^ j54;
                                long j57 = (j41 ^ j47) & 281474976645120L;
                                long j58 = j41 ^ j57;
                                long j59 = j47 ^ j57;
                                long j60 = (j44 ^ j50) & 1099511627520L;
                                this.a[0] = j52;
                                this.a[1] = j55;
                                this.a[2] = j58;
                                this.a[3] = j44 ^ j60;
    ...
    private void d() {
        for (int i2 = 1; i2 < this.f; i2 += 2) {
            long[] jArr = this.c[i2 - 1];
            long[] jArr2 = this.c[i2];
            switch (this.d) {
                case 2:
                    long j2 = jArr[0];
                    long j3 = jArr[1];
