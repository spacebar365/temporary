...
public final class j implements org.bouncycastle.b.e {
    ...
    private static void a(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        iArr2[i4 + 0] = (iArr[i3 + 0] << i2) | (iArr[i3 + 1] >>> (32 - i2));
        iArr2[i4 + 1] = (iArr[i3 + 1] << i2) | (iArr[i3 + 2] >>> (32 - i2));
        iArr2[i4 + 2] = (iArr[i3 + 2] << i2) | (iArr[i3 + 3] >>> (32 - i2));
        iArr2[i4 + 3] = (iArr[i3 + 3] << i2) | (iArr[i3 + 0] >>> (32 - i2));
    ...
    private static void a(int[] iArr, int[] iArr2, int i2) {
        ...
        int i6 = j[(i5 >>> 24) & 255] ^ ((h[i5 & 255] ^ i[(i5 >>> 8) & 255]) ^ k[(i5 >>> 16) & 255]);
        iArr[2] = iArr[2] ^ (i4 ^ i6);
        iArr[3] = (a(i4) ^ (i6 ^ i4)) ^ iArr[3];
        int i7 = iArr[2] ^ iArr2[i2 + 2];
        int i8 = h[(i7 >>> 24) & 255] ^ ((i[i7 & 255] ^ k[(i7 >>> 8) & 255]) ^ j[(i7 >>> 16) & 255]);
        int i9 = iArr[3] ^ iArr2[i2 + 3];
        int i10 = j[(i9 >>> 24) & 255] ^ ((h[i9 & 255] ^ i[(i9 >>> 8) & 255]) ^ k[(i9 >>> 16) & 255]);
        iArr[0] = iArr[0] ^ (i8 ^ i10);
        iArr[1] = (a(i8) ^ (i10 ^ i8)) ^ iArr[1];
    }
    ...
    private static void b(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        iArr2[i4 + 2] = (iArr[i3 + 0] << i2) | (iArr[i3 + 1] >>> (32 - i2));
        iArr2[i4 + 3] = (iArr[i3 + 1] << i2) | (iArr[i3 + 2] >>> (32 - i2));
        iArr2[i4 + 0] = (iArr[i3 + 2] << i2) | (iArr[i3 + 3] >>> (32 - i2));
        iArr2[i4 + 1] = (iArr[i3 + 3] << i2) | (iArr[i3 + 0] >>> (32 - i2));
        iArr[i3 + 0] = iArr2[i4 + 2];
        iArr[i3 + 1] = iArr2[i4 + 3];
        iArr[i3 + 2] = iArr2[i4 + 0];
        iArr[i3 + 3] = iArr2[i4 + 1];
    }

    private static void b(int[] iArr, int[] iArr2, int i2) {
        iArr[1] = iArr[1] ^ b(iArr[0] & iArr2[i2 + 0]);
        iArr[0] = iArr[0] ^ (iArr2[i2 + 1] | iArr[1]);
        iArr[2] = iArr[2] ^ (iArr2[i2 + 3] | iArr[3]);
        iArr[3] = iArr[3] ^ b(iArr2[i2 + 2] & iArr[2]);
    }
    ...
    private static void c(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        iArr2[i4 + 0] = (iArr[i3 + 1] << (i2 - 32)) | (iArr[i3 + 2] >>> (64 - i2));
        iArr2[i4 + 1] = (iArr[i3 + 2] << (i2 - 32)) | (iArr[i3 + 3] >>> (64 - i2));
        iArr2[i4 + 2] = (iArr[i3 + 3] << (i2 - 32)) | (iArr[i3 + 0] >>> (64 - i2));
        iArr2[i4 + 3] = (iArr[i3 + 0] << (i2 - 32)) | (iArr[i3 + 1] >>> (64 - i2));
        iArr[i3 + 0] = iArr2[i4 + 0];
        iArr[i3 + 1] = iArr2[i4 + 1];
        iArr[i3 + 2] = iArr2[i4 + 2];
        iArr[i3 + 3] = iArr2[i4 + 3];
    ...
    private static void d(int i2, int[] iArr, int i3, int[] iArr2, int i4) {
        iArr2[i4 + 2] = (iArr[i3 + 1] << (i2 - 32)) | (iArr[i3 + 2] >>> (64 - i2));
        iArr2[i4 + 3] = (iArr[i3 + 2] << (i2 - 32)) | (iArr[i3 + 3] >>> (64 - i2));
        iArr2[i4 + 0] = (iArr[i3 + 3] << (i2 - 32)) | (iArr[i3 + 0] >>> (64 - i2));
        iArr2[i4 + 1] = (iArr[i3 + 0] << (i2 - 32)) | (iArr[i3 + 1] >>> (64 - i2));
        iArr[i3 + 0] = iArr2[i4 + 2];
        iArr[i3 + 1] = iArr2[i4 + 3];
        iArr[i3 + 2] = iArr2[i4 + 0];
        iArr[i3 + 3] = iArr2[i4 + 1];
    ...
    public final int a(byte[] bArr, int i2, byte[] bArr2, int i3) {
        ...
        return this.b ? b(bArr, i2, bArr2, i3) : c(bArr, i2, bArr2, i3);
    }
    ...
    public final void a(boolean z, org.bouncycastle.b.i iVar) {
        ...
        a(z, ((org.bouncycastle.b.k.ba) iVar).a());
        this.a = true;
    }
