...
public final class av extends aw {
    ...
    protected final int[] a(byte[] bArr) {
        ...
        while (i2 + 4 < bArr.length) {
            iArr[i] = org.bouncycastle.f.g.c(bArr, i2);
            i2 += 4;
            i++;
        }
        if (i2 % 4 != 0) {
        ...
        for (int i4 = 8; i4 < 16; i4++) {
            iArr[i4] = a(((((iArr[i4 - 8] ^ iArr[i4 - 5]) ^ iArr[i4 - 3]) ^ iArr[i4 - 1]) ^ (-1640531527)) ^ (i4 - 8), 11);
        }
        System.arraycopy(iArr, 8, iArr2, 0, 8);
        for (int i5 = 8; i5 < 132; i5++) {
            iArr2[i5] = a(((((iArr2[i5 - 8] ^ iArr2[i5 - 5]) ^ iArr2[i5 - 3]) ^ iArr2[i5 - 1]) ^ (-1640531527)) ^ i5, 11);
        }
    ...
    protected final void b(byte[] bArr, int i, byte[] bArr2, int i2) {
        this.c = org.bouncycastle.f.g.c(bArr, i);
        this.d = org.bouncycastle.f.g.c(bArr, i + 4);
        this.e = org.bouncycastle.f.g.c(bArr, i + 8);
        this.f = org.bouncycastle.f.g.c(bArr, i + 12);
        ...
        org.bouncycastle.f.g.b(this.b[128] ^ this.c, bArr2, i2);
        org.bouncycastle.f.g.b(this.b[129] ^ this.d, bArr2, i2 + 4);
        org.bouncycastle.f.g.b(this.b[130] ^ this.e, bArr2, i2 + 8);
        org.bouncycastle.f.g.b(this.b[131] ^ this.f, bArr2, i2 + 12);
    }

    @Override // org.bouncycastle.b.e.aw
    protected final void c(byte[] bArr, int i, byte[] bArr2, int i2) {
        this.c = this.b[128] ^ org.bouncycastle.f.g.c(bArr, i);
        this.d = this.b[129] ^ org.bouncycastle.f.g.c(bArr, i + 4);
        this.e = this.b[130] ^ org.bouncycastle.f.g.c(bArr, i + 8);
        this.f = this.b[131] ^ org.bouncycastle.f.g.c(bArr, i + 12);
        ...
        e();
        b(this.c, this.d, this.e, this.f);
        org.bouncycastle.f.g.b(this.c ^ this.b[0], bArr2, i2);
        org.bouncycastle.f.g.b(this.d ^ this.b[1], bArr2, i2 + 4);
        org.bouncycastle.f.g.b(this.e ^ this.b[2], bArr2, i2 + 8);
        org.bouncycastle.f.g.b(this.f ^ this.b[3], bArr2, i2 + 12);
    }
}
