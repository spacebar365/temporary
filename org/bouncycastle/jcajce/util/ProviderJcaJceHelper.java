...
public class ProviderJcaJceHelper implements JcaJceHelper {
    ...
    protected final Provider f6278a;
    ...
    public final Cipher mo4520a(String str) {
        return Cipher.getInstance(str, this.f6278a);
    }

    @Override // org.bouncycastle.jcajce.util.JcaJceHelper
    /* JADX INFO: renamed from: b */
    public final Mac mo4521b(String str) {
        return Mac.getInstance(str, this.f6278a);
    }

    @Override // org.bouncycastle.jcajce.util.JcaJceHelper
    /* JADX INFO: renamed from: c */
    public final AlgorithmParameters mo4522c(String str) {
        return AlgorithmParameters.getInstance(str, this.f6278a);
    }

    @Override // org.bouncycastle.jcajce.util.JcaJceHelper
    /* JADX INFO: renamed from: d */
    public final KeyFactory mo4523d(String str) {
        return KeyFactory.getInstance(str, this.f6278a);
    }

    @Override // org.bouncycastle.jcajce.util.JcaJceHelper
    /* JADX INFO: renamed from: e */
    public final SecretKeyFactory mo4524e(String str) {
        return SecretKeyFactory.getInstance(str, this.f6278a);
    }

    @Override // org.bouncycastle.jcajce.util.JcaJceHelper
    /* JADX INFO: renamed from: f */
    public final Signature mo4525f(String str) {
        return Signature.getInstance(str, this.f6278a);
    }

    @Override // org.bouncycastle.jcajce.util.JcaJceHelper
    /* JADX INFO: renamed from: g */
    public final CertificateFactory mo4526g(String str) {
        return CertificateFactory.getInstance(str, this.f6278a);
    }

    @Override // org.bouncycastle.jcajce.util.JcaJceHelper
    /* JADX INFO: renamed from: h */
    public final SecureRandom mo4527h(String str) {
        return SecureRandom.getInstance(str, this.f6278a);
    }
}
