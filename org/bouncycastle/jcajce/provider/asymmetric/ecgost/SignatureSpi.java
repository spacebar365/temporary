...
public class SignatureSpi extends java.security.SignatureSpi implements n, aa {
    private r bO = new d();
    private org.bouncycastle.b.n bP = new f();
    ...
    protected void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        if (publicKey instanceof c) {
            iVarA = publicKey instanceof BCECGOST3410PublicKey ? ((BCECGOST3410PublicKey) publicKey).b() : ECUtil.a(publicKey);
        } else if (publicKey instanceof g) {
            iVarA = GOST3410Util.a(publicKey);
        } else {
            try {
                iVarA = ECUtil.a(org.bouncycastle.c.b.a.a(u.a(publicKey.getEncoded())));
            } catch (Exception e) {
