...
import org.bouncycastle.jcajce.provider.asymmetric.p148ec.BCECPublicKey;
...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    private static final C0512ai f5741d = new C0512ai();

    /* JADX INFO: renamed from: e */
    private String f5742e;

    /* JADX INFO: renamed from: f */
    private C1122y f5743f;

    /* JADX INFO: renamed from: g */
    private C0796g f5744g;
    ...
    public static class ECVKO extends KeyAgreementSpi {
        public ECVKO() {
            super("ECGOST3410", new C0796g(new C0827d()));
        }
    }
    ...
    private static String m4250a(Class cls) {
        String name = cls.getName();
        return name.substring(name.lastIndexOf(46) + 1);
    }

    /* JADX INFO: renamed from: a */
    private void m4251a(Key key, AlgorithmParameterSpec algorithmParameterSpec) throws InvalidKeyException {
        if (!(key instanceof PrivateKey)) {
            throw new InvalidKeyException(this.f5742e + " key agreement requires " + m4250a(InterfaceC1186b.class) + " for initialisation");
        }
        C1052ad c1052ad = (C1052ad) ECUtil.m4328a((PrivateKey) key);
        this.f5743f = c1052ad.m2563b();
        ...
        this.f5744g.m1889a(new C1083bh(c1052ad, this.f5906c));
    }
    ...
    protected void engineInit(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        m4251a(key, algorithmParameterSpec);
    }

    @Override // javax.crypto.KeyAgreementSpi
    protected Key engineDoPhase(Key key, boolean z) throws InvalidKeyException {
        if (this.f5743f == null) {
            throw new IllegalStateException(this.f5742e + " not initialised.");
        }
        if (!z) {
            throw new IllegalStateException(this.f5742e + " can only be between two parties.");
        }
        if (!(key instanceof PublicKey)) {
            throw new InvalidKeyException(this.f5742e + " key agreement requires " + m4250a(InterfaceC1187c.class) + " for doPhase");
        }
        PublicKey publicKey = (PublicKey) key;
        try {
            this.f5745h = this.f5744g.m1890b(publicKey instanceof BCECPublicKey ? ((BCECGOST3410PublicKey) publicKey).m4248b() : ECUtil.m4329a(publicKey));
            return null;
        } catch (Exception e) {
