...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public KeyPair generateKeyPair() {
        ...
        if (this.a instanceof e) {
            e eVar = (e) this.a;
            BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey = new BCECGOST3410_2012PublicKey(this.c, aeVar, eVar);
            return new KeyPair(bCECGOST3410_2012PublicKey, new BCECGOST3410_2012PrivateKey(this.c, adVar, bCECGOST3410_2012PublicKey, eVar));
        }
        if (this.a == null) {
            return new KeyPair(new BCECGOST3410_2012PublicKey(this.c, aeVar), new BCECGOST3410_2012PrivateKey(this.c, adVar));
        }
        ECParameterSpec eCParameterSpec = (ECParameterSpec) this.a;
        BCECGOST3410_2012PublicKey bCECGOST3410_2012PublicKey2 = new BCECGOST3410_2012PublicKey(this.c, aeVar, eCParameterSpec);
        return new KeyPair(bCECGOST3410_2012PublicKey2, new BCECGOST3410_2012PrivateKey(this.c, adVar, bCECGOST3410_2012PublicKey2, eCParameterSpec));
    }
