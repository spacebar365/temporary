...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    private static boolean m4264a(C0653p c0653p) {
        return c0653p.equals(InterfaceC0685a.f2807g) || c0653p.equals(InterfaceC0685a.f2808h) || c0653p.equals(InterfaceC0685a.f2812l) || c0653p.equals(InterfaceC0685a.f2813m);
    }
    ...
    public final PrivateKey mo3997a(C0676p c0676p) throws IOException {
        ...
        if (m4264a(c0653pM1783a)) {
            return new BCECGOST3410_2012PrivateKey(c0676p);
        }
    ...
    public final PublicKey mo3998a(C0780u c0780u) throws IOException {
        ...
        if (m4264a(c0653pM1783a)) {
            return new BCECGOST3410_2012PublicKey(c0780u);
        }
        throw new IOException("algorithm identifier " + c0653pM1783a + " in key not recognised");
    }
    ...
    protected PrivateKey engineGeneratePrivate(KeySpec keySpec) {
        return keySpec instanceof C1209f ? new BCECGOST3410_2012PrivateKey((C1209f) keySpec) : keySpec instanceof ECPrivateKeySpec ? new BCECGOST3410_2012PrivateKey((ECPrivateKeySpec) keySpec) : super.engineGeneratePrivate(keySpec);
    }

    @Override // org.bouncycastle.jcajce.provider.asymmetric.util.BaseKeyFactorySpi, java.security.KeyFactorySpi
    public PublicKey engineGeneratePublic(KeySpec keySpec) {
        return keySpec instanceof C1210g ? new BCECGOST3410_2012PublicKey((C1210g) keySpec, C1200a.f4677a) : keySpec instanceof ECPublicKeySpec ? new BCECGOST3410_2012PublicKey((ECPublicKeySpec) keySpec) : super.engineGeneratePublic(keySpec);
    }
