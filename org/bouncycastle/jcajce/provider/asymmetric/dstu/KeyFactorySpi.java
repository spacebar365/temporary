...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    public final PrivateKey mo3997a(C0676p c0676p) throws IOException {
        ...
        if (c0653pM1783a.equals(InterfaceC0746f.f2988b) || c0653pM1783a.equals(InterfaceC0746f.f2989c)) {
            return new BCDSTU4145PrivateKey(c0676p);
        }
    ...
    public final PublicKey mo3998a(C0780u c0780u) throws IOException {
        ...
        if (c0653pM1783a.equals(InterfaceC0746f.f2988b) || c0653pM1783a.equals(InterfaceC0746f.f2989c)) {
            return new BCDSTU4145PublicKey(c0780u);
        }
        throw new IOException("algorithm identifier " + c0653pM1783a + " in key not recognised");
    }
    ...
    protected PrivateKey engineGeneratePrivate(KeySpec keySpec) {
        return keySpec instanceof C1209f ? new BCDSTU4145PrivateKey((C1209f) keySpec) : keySpec instanceof ECPrivateKeySpec ? new BCDSTU4145PrivateKey((ECPrivateKeySpec) keySpec) : super.engineGeneratePrivate(keySpec);
    }

    @Override // org.bouncycastle.jcajce.provider.asymmetric.util.BaseKeyFactorySpi, java.security.KeyFactorySpi
    protected PublicKey engineGeneratePublic(KeySpec keySpec) {
        return keySpec instanceof C1210g ? new BCDSTU4145PublicKey((C1210g) keySpec, C1200a.f4677a) : keySpec instanceof ECPublicKeySpec ? new BCDSTU4145PublicKey((ECPublicKeySpec) keySpec) : super.engineGeneratePublic(keySpec);
    }
