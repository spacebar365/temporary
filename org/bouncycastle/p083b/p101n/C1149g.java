...
/* JADX INFO: renamed from: org.bouncycastle.b.n.g */
/* JADX INFO: loaded from: classes.dex */
public final class C1149g implements InterfaceC1142n {
    ...
    public final BigInteger mo2746a() {
        return this.f4587a.m2563b().m2701c();
    }
    ...
    public final void mo2715a(boolean z, InterfaceC1003i interfaceC1003i) {
        if (!z) {
            this.f4587a = (C1053ae) interfaceC1003i;
            return;
        }
        if (!(interfaceC1003i instanceof C1081bf)) {
            this.f4588b = C1124l.m2709a();
            this.f4587a = (C1052ad) interfaceC1003i;
        } else {
            C1081bf c1081bf = (C1081bf) interfaceC1003i;
            this.f4588b = c1081bf.m2613a();
            this.f4587a = (C1052ad) c1081bf.m2614b();
        }
    }
    ...
    public final boolean mo2716a(byte[] bArr, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerM2701c = this.f4587a.m2563b().m2701c();
        ...
        AbstractC1389j abstractC1389jM3468o = C1371b.m3274a(this.f4587a.m2563b().m2700b(), bigInteger2.multiply(bigIntegerModInverse).mod(bigIntegerM2701c), ((C1053ae) this.f4587a).m2566c(), bigIntegerM2701c.subtract(bigInteger).multiply(bigIntegerModInverse).mod(bigIntegerM2701c)).m3468o();
    ...
    public final BigInteger[] mo2717a(byte[] bArr) {
        ...
        C1122y c1122yM2563b = this.f4587a.m2563b();
        BigInteger bigIntegerM2701c = c1122yM2563b.m2701c();
        BigInteger bigIntegerM2565c = ((C1052ad) this.f4587a).m2565c();
        C1392m c1392m = new C1392m();
        while (true) {
            BigInteger bigIntegerM4114a = C1544b.m4114a(bigIntegerM2701c.bitLength(), this.f4588b);
