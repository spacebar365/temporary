...
public final class C0826c implements InterfaceC1178u, InterfaceC1554e {
    ...
    public C0826c(int i) {
        ...
        this.f3425b = this.f3426c << 3;
        this.f3428e = new long[this.f3426c];
        this.f3428e[0] = this.f3425b;
        this.f3429f = new long[this.f3426c];
        this.f3430g = new long[this.f3426c];
        this.f3433j = new byte[this.f3425b];
    }

    public C0826c(C0826c c0826c) {
        m1996a(c0826c);
    }

    /* JADX INFO: renamed from: a */
    private static long m1994a(int i, long j) {
        return (j >>> i) | (j << (-i));
    }

    /* JADX INFO: renamed from: a */
    private static long m1995a(long j) {
        long j2 = ((9187201950435737471L & j) << 1) ^ ((((-9187201950435737472L) & j) >>> 7) * 29);
        long jM1994a = m1994a(8, j) ^ j;
        long jM1994a2 = (jM1994a ^ m1994a(16, jM1994a)) ^ m1994a(48, j);
        long j3 = (jM1994a2 ^ j) ^ j2;
        return m1994a(48, j2) ^ ((jM1994a2 ^ m1994a(32, (((j3 & 4629771061636907072L) >>> 6) * 29) ^ (((4557430888798830399L & j3) << 2) ^ ((((-9187201950435737472L) & j3) >>> 6) * 29)))) ^ m1994a(40, j2));
    }

    /* JADX INFO: renamed from: a */
    private void m1996a(C0826c c0826c) {
        this.f3424a = c0826c.f3424a;
        this.f3425b = c0826c.f3425b;
        this.f3427d = c0826c.f3427d;
        if (this.f3426c <= 0 || this.f3426c != c0826c.f3426c) {
            this.f3426c = c0826c.f3426c;
            this.f3428e = C1535a.m4088b(c0826c.f3428e);
            this.f3429f = new long[this.f3426c];
            this.f3430g = new long[this.f3426c];
            this.f3433j = C1535a.m4086b(c0826c.f3433j);
        } else {
            System.arraycopy(c0826c.f3428e, 0, this.f3428e, 0, this.f3426c);
            System.arraycopy(c0826c.f3433j, 0, this.f3433j, 0, this.f3425b);
        }
        this.f3431h = c0826c.f3431h;
        this.f3432i = c0826c.f3432i;
    }

    /* JADX INFO: renamed from: a */
    private void m1997a(long[] jArr) {
        for (int i = 0; i < this.f3427d; i++) {
            long j = i;
            for (int i2 = 0; i2 < this.f3426c; i2++) {
                jArr[i2] = jArr[i2] ^ j;
                j += 16;
            }
            m2001d(jArr);
    ...
    /* JADX INFO: renamed from: b */
    private void m1998b(byte[] bArr, int i) {
        for (int i2 = 0; i2 < this.f3426c; i2++) {
            long jM4153d = AbstractC1556g.m4153d(bArr, i);
            i += 8;
            this.f3429f[i2] = this.f3428e[i2] ^ jM4153d;
            this.f3430g[i2] = jM4153d;
        }
        m1997a(this.f3429f);
        m1999b(this.f3430g);
        for (int i3 = 0; i3 < this.f3426c; i3++) {
            long[] jArr = this.f3428e;
            jArr[i3] = jArr[i3] ^ (this.f3429f[i3] ^ this.f3430g[i3]);
        }
    }

    /* JADX INFO: renamed from: b */
    private void m1999b(long[] jArr) {
        for (int i = 0; i < this.f3427d; i++) {
            long j = 67818912035696883L | (((long) (((this.f3426c - 1) << 4) ^ i)) << 56);
            for (int i2 = 0; i2 < this.f3426c; i2++) {
                jArr[i2] = jArr[i2] + j;
    ...
    /* JADX INFO: renamed from: c */
    private void m2000c(long[] jArr) {
        for (int i = 0; i < this.f3426c; i++) {
            jArr[i] = m1995a(jArr[i]);
        }
    }

    /* JADX INFO: renamed from: d */
    private void m2001d(long[] jArr) {
        switch (this.f3426c) {
            case 8:
                long j = jArr[0];
                long j2 = jArr[1];
    ...
    /* JADX INFO: renamed from: e */
    private void m2002e(long[] jArr) {
        for (int i = 0; i < this.f3426c; i++) {
            long j = jArr[i];
            int i2 = (int) j;
            int i3 = (int) (j >>> 32);
            byte b = f3420k[i2 & 255];
            byte b2 = f3421l[(i2 >>> 8) & 255];
            byte b3 = f3422m[(i2 >>> 16) & 255];
            int i4 = (f3423n[i2 >>> 24] << 24) | (b & 255) | ((b2 & 255) << 8) | ((b3 & 255) << 16);
            byte b4 = f3420k[i3 & 255];
            byte b5 = f3421l[(i3 >>> 8) & 255];
            byte b6 = f3422m[(i3 >>> 16) & 255];
            jArr[i] = (((long) ((f3423n[i3 >>> 24] << 24) | (((b4 & 255) | ((b5 & 255) << 8)) | ((b6 & 255) << 16)))) << 32) | (((long) i4) & 4294967295L);
        }
    }
    ...
    public final int mo1926a(byte[] bArr, int i) {
        int i2 = this.f3432i;
        byte[] bArr2 = this.f3433j;
        int i3 = this.f3432i;
        this.f3432i = i3 + 1;
        bArr2[i3] = -128;
        int i4 = this.f3425b - 12;
        if (this.f3432i > i4) {
            while (this.f3432i < this.f3425b) {
                byte[] bArr3 = this.f3433j;
                int i5 = this.f3432i;
                this.f3432i = i5 + 1;
                bArr3[i5] = 0;
            }
            this.f3432i = 0;
            m1998b(this.f3433j, 0);
        }
        while (this.f3432i < i4) {
            byte[] bArr4 = this.f3433j;
            int i6 = this.f3432i;
            this.f3432i = i6 + 1;
            bArr4[i6] = 0;
        }
        long j = (((this.f3431h & 4294967295L) * ((long) this.f3425b)) + ((long) i2)) << 3;
        AbstractC1556g.m4147b((int) j, this.f3433j, this.f3432i);
        this.f3432i += 4;
        AbstractC1556g.m4148b((j >>> 32) + (((this.f3431h >>> 32) * ((long) this.f3425b)) << 3), this.f3433j, this.f3432i);
        m1998b(this.f3433j, 0);
        System.arraycopy(this.f3428e, 0, this.f3429f, 0, this.f3426c);
        m1997a(this.f3429f);
        for (int i7 = 0; i7 < this.f3426c; i7++) {
            long[] jArr = this.f3428e;
            jArr[i7] = jArr[i7] ^ this.f3429f[i7];
        }
        for (int i8 = this.f3426c - (this.f3424a >>> 3); i8 < this.f3426c; i8++) {
            AbstractC1556g.m4148b(this.f3428e[i8], bArr, i);
            i += 8;
        }
        mo1931c();
        return this.f3424a;
    ...
    public final void mo1928a(byte b) {
        byte[] bArr = this.f3433j;
        int i = this.f3432i;
        this.f3432i = i + 1;
        bArr[i] = b;
        if (this.f3432i == this.f3425b) {
            m1998b(this.f3433j, 0);
            this.f3432i = 0;
            this.f3431h++;
        }
    ...
    public final void mo1939a(InterfaceC1554e interfaceC1554e) {
        m1996a((C0826c) interfaceC1554e);
    }

    @Override // org.bouncycastle.p083b.InterfaceC1175r
    /* JADX INFO: renamed from: a */
    public final void mo1929a(byte[] bArr, int i, int i2) {
        while (this.f3432i != 0 && i2 > 0) {
            mo1928a(bArr[i]);
            i2--;
            i++;
        }
        if (i2 > 0) {
            while (i2 >= this.f3425b) {
                m1998b(bArr, i);
                i += this.f3425b;
                i2 -= this.f3425b;
                this.f3431h++;
