...
public final class C0933j implements InterfaceC0890e {
    ...
    private int[] f3880c = new int[96];

    /* JADX INFO: renamed from: d */
    private int[] f3881d = new int[8];

    /* JADX INFO: renamed from: e */
    private int[] f3882e = new int[12];

    /* JADX INFO: renamed from: f */
    private int[] f3883f = new int[4];

    /* JADX INFO: renamed from: a */
    private static int m2333a(int i) {
        return (i >>> 8) + (i << 24);
    }

    /* JADX INFO: renamed from: a */
    private static int m2334a(byte[] bArr, int i) {
        int i2 = 0;
        int i3 = 0;
        while (true) {
            int i4 = i2;
    ...
    /* JADX INFO: renamed from: a */
    private static void m2335a(int i, byte[] bArr, int i2) {
    ...
    /* JADX INFO: renamed from: a */
    private static void m2336a(int i, int[] iArr, int i2, int[] iArr2, int i3) {
    ...
    /* JADX INFO: renamed from: a */
    private void m2337a(boolean z, byte[] bArr) {
        int[] iArr = new int[8];
        int[] iArr2 = new int[4];
        int[] iArr3 = new int[4];
        int[] iArr4 = new int[4];
        switch (bArr.length) {
            case 16:
                this.f3879b = true;
                iArr[0] = m2334a(bArr, 0);
                iArr[1] = m2334a(bArr, 4);
                iArr[2] = m2334a(bArr, 8);
                iArr[3] = m2334a(bArr, 12);
                iArr[7] = 0;
                iArr[6] = 0;
                iArr[5] = 0;
                iArr[4] = 0;
            ...
            case 24:
                ...
                iArr[2] = m2334a(bArr, 8);
                iArr[3] = m2334a(bArr, 12);
                iArr[4] = m2334a(bArr, 16);
                iArr[5] = m2334a(bArr, 20);
                iArr[6] = iArr[4] ^ (-1);
                iArr[7] = iArr[5] ^ (-1);
                this.f3879b = false;
                break;
            case 32:
                ...
                iArr[4] = m2334a(bArr, 16);
                iArr[5] = m2334a(bArr, 20);
                iArr[6] = m2334a(bArr, 24);
                iArr[7] = m2334a(bArr, 28);
                this.f3879b = false;
                break;
            default:
        ...
        m2338a(iArr2, f3873g, 0);
        for (int i2 = 0; i2 < 4; i2++) {
            iArr2[i2] = iArr2[i2] ^ iArr[i2];
        }
        m2338a(iArr2, f3873g, 4);
        if (this.f3879b) {
            if (z) {
                this.f3881d[0] = iArr[0];
                this.f3881d[1] = iArr[1];
                this.f3881d[2] = iArr[2];
                this.f3881d[3] = iArr[3];
                m2336a(15, iArr, 0, this.f3880c, 4);
                m2336a(30, iArr, 0, this.f3880c, 12);
                m2336a(15, iArr, 0, iArr4, 0);
                this.f3880c[18] = iArr4[2];
                this.f3880c[19] = iArr4[3];
                m2336a(17, iArr, 0, this.f3882e, 4);
                m2336a(17, iArr, 0, this.f3880c, 24);
                m2336a(17, iArr, 0, this.f3880c, 32);
                this.f3880c[0] = iArr2[0];
                this.f3880c[1] = iArr2[1];
                this.f3880c[2] = iArr2[2];
                this.f3880c[3] = iArr2[3];
                m2336a(15, iArr2, 0, this.f3880c, 8);
                m2336a(15, iArr2, 0, this.f3882e, 0);
                m2336a(15, iArr2, 0, iArr4, 0);
                this.f3880c[16] = iArr4[0];
                this.f3880c[17] = iArr4[1];
                m2336a(15, iArr2, 0, this.f3880c, 20);
                m2344c(34, iArr2, 0, this.f3880c, 28);
                m2336a(17, iArr2, 0, this.f3881d, 4);
                return;
            }
            this.f3881d[4] = iArr[0];
            this.f3881d[5] = iArr[1];
            this.f3881d[6] = iArr[2];
            this.f3881d[7] = iArr[3];
            m2341b(15, iArr, 0, this.f3880c, 28);
            m2341b(30, iArr, 0, this.f3880c, 20);
            m2341b(15, iArr, 0, iArr4, 0);
            this.f3880c[16] = iArr4[0];
            this.f3880c[17] = iArr4[1];
            m2341b(17, iArr, 0, this.f3882e, 0);
            m2341b(17, iArr, 0, this.f3880c, 8);
            m2341b(17, iArr, 0, this.f3880c, 0);
            this.f3880c[34] = iArr2[0];
            this.f3880c[35] = iArr2[1];
            this.f3880c[32] = iArr2[2];
            this.f3880c[33] = iArr2[3];
            m2341b(15, iArr2, 0, this.f3880c, 24);
            m2341b(15, iArr2, 0, this.f3882e, 4);
            m2341b(15, iArr2, 0, iArr4, 0);
            this.f3880c[18] = iArr4[2];
            this.f3880c[19] = iArr4[3];
            m2341b(15, iArr2, 0, this.f3880c, 12);
            m2345d(34, iArr2, 0, this.f3880c, 4);
            m2336a(17, iArr2, 0, this.f3881d, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
            iArr3[i3] = iArr2[i3] ^ iArr[i3 + 4];
        }
        m2338a(iArr3, f3873g, 8);
        if (z) {
            this.f3881d[0] = iArr[0];
            this.f3881d[1] = iArr[1];
            this.f3881d[2] = iArr[2];
            this.f3881d[3] = iArr[3];
            m2344c(45, iArr, 0, this.f3880c, 16);
            m2336a(15, iArr, 0, this.f3882e, 4);
            m2336a(17, iArr, 0, this.f3880c, 32);
            m2344c(34, iArr, 0, this.f3880c, 44);
            m2336a(15, iArr, 4, this.f3880c, 4);
            m2336a(15, iArr, 4, this.f3882e, 0);
            m2336a(30, iArr, 4, this.f3880c, 24);
            m2344c(34, iArr, 4, this.f3880c, 36);
            m2336a(15, iArr2, 0, this.f3880c, 8);
            m2336a(30, iArr2, 0, this.f3880c, 20);
            this.f3882e[8] = iArr2[1];
            this.f3882e[9] = iArr2[2];
            this.f3882e[10] = iArr2[3];
            this.f3882e[11] = iArr2[0];
            m2344c(49, iArr2, 0, this.f3880c, 40);
            this.f3880c[0] = iArr3[0];
            this.f3880c[1] = iArr3[1];
            this.f3880c[2] = iArr3[2];
            this.f3880c[3] = iArr3[3];
            m2336a(30, iArr3, 0, this.f3880c, 12);
            m2336a(30, iArr3, 0, this.f3880c, 28);
            m2344c(51, iArr3, 0, this.f3881d, 4);
            return;
        }
        this.f3881d[4] = iArr[0];
        this.f3881d[5] = iArr[1];
        this.f3881d[6] = iArr[2];
        this.f3881d[7] = iArr[3];
        m2345d(45, iArr, 0, this.f3880c, 28);
        m2341b(15, iArr, 0, this.f3882e, 4);
        m2341b(17, iArr, 0, this.f3880c, 12);
        m2345d(34, iArr, 0, this.f3880c, 0);
        m2341b(15, iArr, 4, this.f3880c, 40);
        m2341b(15, iArr, 4, this.f3882e, 8);
        m2341b(30, iArr, 4, this.f3880c, 20);
        m2345d(34, iArr, 4, this.f3880c, 8);
        m2341b(15, iArr2, 0, this.f3880c, 36);
        m2341b(30, iArr2, 0, this.f3880c, 24);
        this.f3882e[2] = iArr2[1];
        this.f3882e[3] = iArr2[2];
        this.f3882e[0] = iArr2[3];
        this.f3882e[1] = iArr2[0];
        m2345d(49, iArr2, 0, this.f3880c, 4);
        this.f3880c[46] = iArr3[0];
        this.f3880c[47] = iArr3[1];
        this.f3880c[44] = iArr3[2];
        this.f3880c[45] = iArr3[3];
        m2341b(30, iArr3, 0, this.f3880c, 32);
        m2341b(30, iArr3, 0, this.f3880c, 16);
        m2344c(51, iArr3, 0, this.f3881d, 0);
    }

    /* JADX INFO: renamed from: a */
    private static void m2338a(int[] iArr, int[] iArr2, int i) {
        int i2 = iArr[0] ^ iArr2[i + 0];
        int i3 = f3874h[(i2 >>> 24) & 255] ^ ((f3875i[i2 & 255] ^ f3877k[(i2 >>> 8) & 255]) ^ f3876j[(i2 >>> 16) & 255]);
        int i4 = iArr[1] ^ iArr2[i + 1];
        int i5 = f3876j[(i4 >>> 24) & 255] ^ ((f3874h[i4 & 255] ^ f3875i[(i4 >>> 8) & 255]) ^ f3877k[(i4 >>> 16) & 255]);
        iArr[2] = iArr[2] ^ (i3 ^ i5);
        iArr[3] = (m2333a(i3) ^ (i5 ^ i3)) ^ iArr[3];
        int i6 = iArr[2] ^ iArr2[i + 2];
        int i7 = f3874h[(i6 >>> 24) & 255] ^ ((f3875i[i6 & 255] ^ f3877k[(i6 >>> 8) & 255]) ^ f3876j[(i6 >>> 16) & 255]);
        int i8 = iArr[3] ^ iArr2[i + 3];
        int i9 = f3876j[(i8 >>> 24) & 255] ^ ((f3874h[i8 & 255] ^ f3875i[(i8 >>> 8) & 255]) ^ f3877k[(i8 >>> 16) & 255]);
        iArr[0] = iArr[0] ^ (i7 ^ i9);
        iArr[1] = (m2333a(i7) ^ (i9 ^ i7)) ^ iArr[1];
    }

    /* JADX INFO: renamed from: b */
    private static int m2339b(int i) {
        return (i << 1) + (i >>> 31);
    }

    /* JADX INFO: renamed from: b */
    private int m2340b(byte[] bArr, int i, byte[] bArr2, int i2) {
        for (int i3 = 0; i3 < 4; i3++) {
            this.f3883f[i3] = m2334a(bArr, (i3 * 4) + i);
            int[] iArr = this.f3883f;
            iArr[i3] = iArr[i3] ^ this.f3881d[i3];
        }
        m2338a(this.f3883f, this.f3880c, 0);
        m2338a(this.f3883f, this.f3880c, 4);
        m2338a(this.f3883f, this.f3880c, 8);
        m2342b(this.f3883f, this.f3882e, 0);
        m2338a(this.f3883f, this.f3880c, 12);
        m2338a(this.f3883f, this.f3880c, 16);
        m2338a(this.f3883f, this.f3880c, 20);
        m2342b(this.f3883f, this.f3882e, 4);
        m2338a(this.f3883f, this.f3880c, 24);
        m2338a(this.f3883f, this.f3880c, 28);
        m2338a(this.f3883f, this.f3880c, 32);
        int[] iArr2 = this.f3883f;
        iArr2[2] = iArr2[2] ^ this.f3881d[4];
        int[] iArr3 = this.f3883f;
        iArr3[3] = iArr3[3] ^ this.f3881d[5];
        int[] iArr4 = this.f3883f;
        iArr4[0] = iArr4[0] ^ this.f3881d[6];
        int[] iArr5 = this.f3883f;
        iArr5[1] = iArr5[1] ^ this.f3881d[7];
        m2335a(this.f3883f[2], bArr2, i2);
        m2335a(this.f3883f[3], bArr2, i2 + 4);
        m2335a(this.f3883f[0], bArr2, i2 + 8);
        m2335a(this.f3883f[1], bArr2, i2 + 12);
        return 16;
    }

    /* JADX INFO: renamed from: b */
    private static void m2341b(int i, int[] iArr, int i2, int[] iArr2, int i3) {
    ...
    /* JADX INFO: renamed from: b */
    private static void m2342b(int[] iArr, int[] iArr2, int i) {
        iArr[1] = iArr[1] ^ m2339b(iArr[0] & iArr2[i + 0]);
        iArr[0] = iArr[0] ^ (iArr2[i + 1] | iArr[1]);
        iArr[2] = iArr[2] ^ (iArr2[i + 3] | iArr[3]);
        iArr[3] = iArr[3] ^ m2339b(iArr2[i + 2] & iArr[2]);
    }

    /* JADX INFO: renamed from: c */
    private int m2343c(byte[] bArr, int i, byte[] bArr2, int i2) {
        for (int i3 = 0; i3 < 4; i3++) {
            this.f3883f[i3] = m2334a(bArr, (i3 * 4) + i);
            int[] iArr = this.f3883f;
            iArr[i3] = iArr[i3] ^ this.f3881d[i3];
        ...
        m2338a(this.f3883f, this.f3880c, 28);
        m2338a(this.f3883f, this.f3880c, 32);
        m2342b(this.f3883f, this.f3882e, 8);
        m2338a(this.f3883f, this.f3880c, 36);
        m2338a(this.f3883f, this.f3880c, 40);
        m2338a(this.f3883f, this.f3880c, 44);
        int[] iArr2 = this.f3883f;
        iArr2[2] = iArr2[2] ^ this.f3881d[4];
        int[] iArr3 = this.f3883f;
        iArr3[3] = iArr3[3] ^ this.f3881d[5];
    ...
    /* JADX INFO: renamed from: c */
    private static void m2344c(int i, int[] iArr, int i2, int[] iArr2, int i3) {
    ...
    /* JADX INFO: renamed from: d */
    private static void m2345d(int i, int[] iArr, int i2, int[] iArr2, int i3) {
    ...
    public final int mo2122a(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        return this.f3879b ? m2340b(bArr, i, bArr2, i2) : m2343c(bArr, i, bArr2, i2);
    }
    ...
    public final void mo2124a(boolean z, InterfaceC1003i interfaceC1003i) {
        ...
        m2337a(z, ((C1076ba) interfaceC1003i).m2603a());
        this.f3878a = true;
    }
