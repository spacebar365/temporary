...
/* JADX INFO: renamed from: org.bouncycastle.d.c.d */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC1417d {
    /* JADX INFO: renamed from: a */
    public static int m3603a(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* JADX INFO: renamed from: a */
    public static void m3604a(int[] iArr, int[] iArr2, int i) {
        iArr2[i + 0] = iArr[0];
        iArr2[i + 1] = iArr[1];
        iArr2[i + 2] = iArr[2];
        iArr2[i + 3] = iArr[3];
    ...
    /* JADX INFO: renamed from: a */
    public static void m3605a(long[] jArr, long[] jArr2, int i) {
        jArr2[i + 0] = jArr[0];
        jArr2[i + 1] = jArr[1];
    }

    /* JADX INFO: renamed from: a */
    public static boolean m3606a(int[] iArr) {
        if (iArr[0] != 1) {
            return false;
        }
        for (int i = 1; i < 4; i++) {
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m3607a(int[] iArr, int[] iArr2) {
        for (int i = 3; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m3608a(long[] jArr) {
        for (int i = 0; i < 2; i++) {
            if (jArr[i] != 0) {
                return false;
            }
    ...
    public static void m3609b(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* JADX INFO: renamed from: b */
    public static boolean m3610b(int[] iArr) {
        for (int i = 0; i < 4; i++) {
            if (iArr[i] != 0) {
                return false;
            }
    ...
    /* JADX INFO: renamed from: b */
    public static boolean m3611b(int[] iArr, int[] iArr2) {
        for (int i = 3; i >= 0; i--) {
    ...
    public static int m3612c(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* JADX INFO: renamed from: c */
    public static void m3613c(int[] iArr, int[] iArr2) {
