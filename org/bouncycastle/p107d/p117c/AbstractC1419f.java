...
/* JADX INFO: renamed from: org.bouncycastle.d.c.f */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC1419f {
    /* JADX INFO: renamed from: a */
    public static int m3632a(long j, int[] iArr) {
        ...
        return AbstractC1416c.m3592c(6, iArr, 4);
    }

    /* JADX INFO: renamed from: a */
    public static int m3633a(int[] iArr, int i, int[] iArr2, int i2, int i3) {
    ...
    /* JADX INFO: renamed from: a */
    private static int m3634a(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3) {
    ...
    /* JADX INFO: renamed from: a */
    public static int m3635a(int[] iArr, int[] iArr2) {
    ...
    /* JADX INFO: renamed from: a */
    public static int m3636a(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* JADX INFO: renamed from: a */
    public static void m3637a(int[] iArr, int[] iArr2, int i) {
        iArr2[i + 0] = iArr[0];
        iArr2[i + 1] = iArr[1];
        iArr2[i + 2] = iArr[2];
        iArr2[i + 3] = iArr[3];
    ...
    /* JADX INFO: renamed from: a */
    public static void m3638a(int[] iArr, int[] iArr2, int[] iArr3, int i) {
    ...
    /* JADX INFO: renamed from: a */
    public static void m3639a(long[] jArr, long[] jArr2, int i) {
        jArr2[i + 0] = jArr[0];
        jArr2[i + 1] = jArr[1];
        jArr2[i + 2] = jArr[2];
    }
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m3640a(int[] iArr) {
        if (iArr[0] != 1) {
            return false;
        }
        for (int i = 1; i < 6; i++) {
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m3641a(long[] jArr) {
        if (jArr[0] != 1) {
            return false;
        }
        for (int i = 1; i < 3; i++) {
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m3642a(long[] jArr, long[] jArr2) {
        for (int i = 2; i >= 0; i--) {
            if (jArr[i] != jArr2[i]) {
                return false;
            }
    ...
    public static int m3644b(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* JADX INFO: renamed from: b */
    public static boolean m3645b(int[] iArr) {
        for (int i = 0; i < 6; i++) {
            if (iArr[i] != 0) {
                return false;
            }
    ...
    /* JADX INFO: renamed from: b */
    public static boolean m3646b(int[] iArr, int[] iArr2) {
        for (int i = 5; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    /* JADX INFO: renamed from: b */
    public static boolean m3647b(long[] jArr) {
        for (int i = 0; i < 3; i++) {
            if (jArr[i] != 0) {
                return false;
            }
    ...
    public static BigInteger m3649c(int[] iArr) {
        byte[] bArr = new byte[24];
        for (int i = 0; i < 6; i++) {
            int i2 = iArr[i];
            if (i2 != 0) {
                AbstractC1556g.m4136a(i2, bArr, (5 - i) << 2);
            }
        }
    ...
    /* JADX INFO: renamed from: c */
    public static BigInteger m3650c(long[] jArr) {
        byte[] bArr = new byte[24];
        for (int i = 0; i < 3; i++) {
            long j = jArr[i];
            if (j != 0) {
                AbstractC1556g.m4137a(j, bArr, (2 - i) << 3);
            }
        }
        return new BigInteger(1, bArr);
    }
    ...
    /* JADX INFO: renamed from: c */
    public static boolean m3651c(int[] iArr, int[] iArr2) {
        for (int i = 5; i >= 0; i--) {
    ...
    public static void m3653d(int[] iArr) {
        iArr[0] = 0;
        iArr[1] = 0;
        iArr[2] = 0;
        iArr[3] = 0;
    ...
    /* JADX INFO: renamed from: d */
    public static void m3654d(int[] iArr, int[] iArr2) {
    ...
    /* JADX INFO: renamed from: d */
    public static void m3655d(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    public static int m3656e(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* JADX INFO: renamed from: e */
    public static void m3657e(int[] iArr, int[] iArr2) {
    ...
    public static int m3658f(int[] iArr, int[] iArr2) {
    ...
    /* JADX INFO: renamed from: f */
    public static long m3659f(int[] iArr, int[] iArr2, int[] iArr3) {
        long j = ((long) iArr[6]) & 4294967295L;
    ...
    public static int m3660g(int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0 + ((((long) iArr[0]) & 4294967295L) - (((long) iArr2[0]) & 4294967295L));
        iArr3[0] = (int) j;
        long j2 = (j >> 32) + ((((long) iArr[1]) & 4294967295L) - (((long) iArr2[1]) & 4294967295L));
        iArr3[1] = (int) j2;
    ...
    /* JADX INFO: renamed from: c */
    public static boolean m3652c(int[] iArr, int[] iArr2, int[] iArr3) {
        boolean z;
        for (int i = 5; i >= 0; i--) {
        ...
        z = true;
        if (z) {
            m3634a(iArr, 6, iArr2, 0, iArr3);
        } else {
            m3634a(iArr2, 0, iArr, 6, iArr3);
        }
        return z;
    }

    /* JADX INFO: renamed from: a */
    public static int[] m3643a(BigInteger bigInteger) {
    ...
    /* JADX INFO: renamed from: b */
    public static long[] m3648b(BigInteger bigInteger) {
        if (bigInteger.signum() < 0 || bigInteger.bitLength() > 192) {
            throw new IllegalArgumentException();
        }
