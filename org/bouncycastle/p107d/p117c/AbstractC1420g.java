...
/* JADX INFO: renamed from: org.bouncycastle.d.c.g */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC1420g {
    /* JADX INFO: renamed from: a */
    public static int m3661a(long j, int[] iArr) {
        ...
        return AbstractC1416c.m3592c(7, iArr, 4);
    }

    /* JADX INFO: renamed from: a */
    public static int m3662a(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* JADX INFO: renamed from: a */
    public static void m3663a(int[] iArr, int[] iArr2) {
        iArr2[0] = iArr[0];
        iArr2[1] = iArr[1];
        iArr2[2] = iArr[2];
        iArr2[3] = iArr[3];
    ...
    /* JADX INFO: renamed from: a */
    public static void m3664a(int[] iArr, int[] iArr2, int i) {
        iArr2[i + 0] = iArr[0];
        iArr2[i + 1] = iArr[1];
        iArr2[i + 2] = iArr[2];
        iArr2[i + 3] = iArr[3];
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m3665a(int[] iArr) {
        if (iArr[0] != 1) {
            return false;
        }
        for (int i = 1; i < 7; i++) {
    ...
    public static int m3667b(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* JADX INFO: renamed from: b */
    public static boolean m3668b(int[] iArr) {
        for (int i = 0; i < 7; i++) {
            if (iArr[i] != 0) {
                return false;
            }
    ...
    /* JADX INFO: renamed from: b */
    public static boolean m3669b(int[] iArr, int[] iArr2) {
        for (int i = 6; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static BigInteger m3670c(int[] iArr) {
        byte[] bArr = new byte[28];
        for (int i = 0; i < 7; i++) {
            int i2 = iArr[i];
            if (i2 != 0) {
                AbstractC1556g.m4136a(i2, bArr, (6 - i) << 2);
            }
        }
    ...
    /* JADX INFO: renamed from: c */
    public static void m3671c(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* JADX INFO: renamed from: c */
    public static boolean m3672c(int[] iArr, int[] iArr2) {
        for (int i = 6; i >= 0; i--) {
    ...
    public static int m3673d(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* JADX INFO: renamed from: d */
    public static void m3674d(int[] iArr) {
        iArr[0] = 0;
        iArr[1] = 0;
        iArr[2] = 0;
        iArr[3] = 0;
    ...
    /* JADX INFO: renamed from: d */
    public static void m3675d(int[] iArr, int[] iArr2) {
    ...
    public static long m3676e(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    public static int m3677f(int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0 + ((((long) iArr[0]) & 4294967295L) - (((long) iArr2[0]) & 4294967295L));
        iArr3[0] = (int) j;
        long j2 = (j >> 32) + ((((long) iArr[1]) & 4294967295L) - (((long) iArr2[1]) & 4294967295L));
        iArr3[1] = (int) j2;
    ...
    /* JADX INFO: renamed from: a */
    public static int[] m3666a(BigInteger bigInteger) {
