package org.bouncycastle.p107d;

import java.math.BigInteger;
import java.security.SecureRandom;
import org.bouncycastle.p142f.C1544b;

/* JADX INFO: renamed from: org.bouncycastle.d.a */
/* JADX INFO: loaded from: classes.dex */
public abstract class AbstractC1222a {

    /* JADX INFO: renamed from: a */
    private static final BigInteger f4744a = BigInteger.valueOf(1);

    /* JADX INFO: renamed from: b */
    private static final BigInteger f4745b = BigInteger.valueOf(2);

    /* JADX INFO: renamed from: c */
    private static final BigInteger f4746c = BigInteger.valueOf(3);

    /* JADX INFO: renamed from: a */
    private static void m2899a(BigInteger bigInteger, String str) {
    ...
    /* JADX INFO: renamed from: a */
    private static boolean m2901a(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, int i, BigInteger bigInteger4) {
        BigInteger bigIntegerModPow = bigInteger4.modPow(bigInteger3, bigInteger);
        if (bigIntegerModPow.equals(f4744a) || bigIntegerModPow.equals(bigInteger2)) {
            return true;
        }
        for (int i2 = 1; i2 < i; i2++) {
            bigIntegerModPow = bigIntegerModPow.modPow(f4745b, bigInteger);
            if (bigIntegerModPow.equals(bigInteger2)) {
                return true;
            }
            if (bigIntegerModPow.equals(f4744a)) {
                return false;
            }
        }
        return false;
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m2902a(BigInteger bigInteger, SecureRandom secureRandom, int i) {
        m2899a(bigInteger, "candidate");
        ...
        BigInteger bigIntegerSubtract = bigInteger.subtract(f4744a);
        BigInteger bigIntegerSubtract2 = bigInteger.subtract(f4745b);
        ...
        for (int i2 = 0; i2 < i; i2++) {
            if (!m2901a(bigInteger, bigIntegerSubtract, bigIntegerShiftRight, lowestSetBit, C1544b.m4115a(f4745b, bigIntegerSubtract2, secureRandom))) {
                return false;
            }
        }
        return true;
    ...
    /* JADX INFO: renamed from: a */
    public static boolean m2900a(BigInteger bigInteger) {
        m2899a(bigInteger, "candidate");
