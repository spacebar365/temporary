...
/* JADX INFO: renamed from: org.bouncycastle.d.a.a.c.r */
/* JADX INFO: loaded from: classes.dex */
public final class C1355r extends AbstractC1389j.b {
    public C1355r(AbstractC1381d abstractC1381d, AbstractC1386g abstractC1386g, AbstractC1386g abstractC1386g2) {
        this(abstractC1381d, abstractC1386g, abstractC1386g2, false);
    }

    public C1355r(AbstractC1381d abstractC1381d, AbstractC1386g abstractC1386g, AbstractC1386g abstractC1386g2, boolean z) {
    ...
    C1355r(AbstractC1381d abstractC1381d, AbstractC1386g abstractC1386g, AbstractC1386g abstractC1386g2, AbstractC1386g[] abstractC1386gArr, boolean z) {
    ...
    protected final AbstractC1389j mo2948e() {
        return new C1355r(null, m3461g(), m3462h());
    }

    @Override // org.bouncycastle.p107d.p108a.AbstractC1389j
    /* JADX INFO: renamed from: s */
    public final AbstractC1389j mo2949s() {
        return m3469p() ? this : new C1355r(this.f5077b, this.f5078c, this.f5079d.mo2934d(), this.f5080e, this.f5081f);
    }
    ...
    public final AbstractC1389j mo2946b(AbstractC1389j abstractC1389j) {
        ...
        return new C1355r(abstractC1381dD, c1354q7, c1354q8, new AbstractC1386g[]{c1354q9}, this.f5081f);
    }
    ...
    public final AbstractC1389j mo2950t() {
        ...
        int[] iArr2 = new int[5];
        int[] iArr3 = new int[5];
        C1353p.m3228d(c1354q.f4947b, iArr3);
        int[] iArr4 = new int[5];
        C1353p.m3228d(iArr3, iArr4);
        boolean zMo2939i = c1354q3.mo2939i();
        int[] iArr5 = c1354q3.f4947b;
        if (!zMo2939i) {
            C1353p.m3228d(c1354q3.f4947b, iArr2);
            iArr5 = iArr2;
        }
        C1353p.m3229d(c1354q2.f4947b, iArr5, iArr);
        C1353p.m3222a(c1354q2.f4947b, iArr5, iArr2);
        C1353p.m3225b(iArr2, iArr, iArr2);
        C1353p.m3219a(AbstractC1418e.m3621b(iArr2, iArr2, iArr2), iArr2);
        C1353p.m3225b(iArr3, c1354q2.f4947b, iArr3);
        C1353p.m3219a(AbstractC1416c.m3600e(5, iArr3, 0), iArr3);
        C1353p.m3219a(AbstractC1416c.m3585b(5, iArr4, 0, iArr), iArr);
        C1354q c1354q4 = new C1354q(iArr4);
        C1353p.m3228d(iArr2, c1354q4.f4947b);
        C1353p.m3229d(c1354q4.f4947b, iArr3, c1354q4.f4947b);
        C1353p.m3229d(c1354q4.f4947b, iArr3, c1354q4.f4947b);
        C1354q c1354q5 = new C1354q(iArr3);
        C1353p.m3229d(iArr3, c1354q4.f4947b, c1354q5.f4947b);
        C1353p.m3225b(c1354q5.f4947b, iArr2, c1354q5.f4947b);
        C1353p.m3229d(c1354q5.f4947b, iArr, c1354q5.f4947b);
        C1354q c1354q6 = new C1354q(iArr2);
        C1353p.m3230e(c1354q.f4947b, c1354q6.f4947b);
        if (!zMo2939i) {
            C1353p.m3225b(c1354q6.f4947b, c1354q3.f4947b, c1354q6.f4947b);
        }
        return new C1355r(abstractC1381dD, c1354q4, c1354q5, new AbstractC1386g[]{c1354q6}, this.f5081f);
    }
}
