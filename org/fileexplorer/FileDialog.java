...
import com.al.dlnaserver.R$menu;
...
public class FileDialog extends ListActivity {
    ...
    static /* synthetic */ EditText a(FileDialog fileDialog) {
        return fileDialog.d;
    }

    static /* synthetic */ int c(FileDialog fileDialog) {
        return fileDialog.f;
    }

    static /* synthetic */ String b(FileDialog fileDialog) {
        return fileDialog.k;
    }

    static /* synthetic */ int d(FileDialog fileDialog) {
        return fileDialog.u;
    }

    static /* synthetic */ int e(FileDialog fileDialog) {
        return fileDialog.v;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) throws Throwable {
        ...
        switch (menuItem.getItemId()) {
            case R$id.action_close /* 2131361857 */:
                finish();
                return true;
            case R$id.action_select /* 2131361858 */:
                if (this.p != null) {
                ...
                return true;
            case R$id.action_new /* 2131361859 */:
            ...
            case R$id.action_home /* 2131361860 */:
                ...
                a(absolutePath);
                return true;
            case R$id.action_open /* 2131361861 */:
