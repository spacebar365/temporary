...
/* JADX INFO: renamed from: com.al.dlnaserver.b.b */
/* JADX INFO: compiled from: FilePicker.java */
/* JADX INFO: loaded from: classes.dex */
public final class C0335b {

    /* JADX INFO: renamed from: a */
    private static String f1375a = "FilePicker";

    @TargetApi(19)
    /* JADX INFO: renamed from: a */
    public static String m1010a(Context context, Uri uri) {
        boolean z;
        String str;
        boolean z2 = Build.VERSION.SDK_INT >= 19;
        Log.i(f1375a, "uri=" + uri.toString());
        if (z2 && DocumentsContract.isDocumentUri(context, uri)) {
            if ("com.android.externalstorage.documents".equals(uri.getAuthority())) {
                ...
                if ("com.android.providers.downloads.documents".equals(uri.getAuthority())) {
                    ...
                    try {
                        return m1011a(context, ContentUris.withAppendedId(Uri.parse("content://downloads/public_downloads"), Long.valueOf(documentId).longValue()), null, null);
                        ...
                        Log.e(f1375a, "Long.valueOf(id), id=".concat(String.valueOf(documentId)), e2);
                        return null;
                    }
                }
                if ("com.android.providers.media.documents".equals(uri.getAuthority())) {
                    ...
                    return m1011a(context, uri, "_id=?", new String[]{strArrSplit2[1]});
                }
            }
        } else {
            if ("content".equalsIgnoreCase(uri.getScheme())) {
                ...
                String strM1011a = m1011a(context, uri, null, null);
                if (strM1011a == null) {
                    return null;
                }
                return strM1011a;
    ...
    */
    private static java.lang.String m1011a(android.content.Context r7, android.net.Uri r8, java.lang.String r9, java.lang.String[] r10) throws java.lang.Throwable {
        /*
            r6 = 0
            r0 = 1
        ...
        L2d:
            ...
            r1 = r6
        L2f:
            java.lang.String r2 = com.p033al.dlnaserver.p035b.C0335b.f1375a     // Catch: java.lang.Throwable -> L4b
        ...
        L4d:
            ...
            goto L2f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p033al.dlnaserver.p035b.C0335b.m1011a(android.content.Context, android.net.Uri, java.lang.String, java.lang.String[]):java.lang.String");
    }
}
